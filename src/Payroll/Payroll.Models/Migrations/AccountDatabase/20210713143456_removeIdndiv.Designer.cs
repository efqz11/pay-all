...
namespace Payroll.Models.Migrations.AccountDatabase
{
    ...
    [Migration("20210713143456_removeIdndiv")]
    partial class removeIdndiv
    {
            ...
            modelBuilder.Entity("Payroll.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("SurveyCs_EmpRoleString")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SurveyCs_PayingToWhom")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Payroll.Models.CompanyAccount", b =>
                {
                    ...
                    b.HasOne("Payroll.Models.AppUser", "AppUserOwner")
                        .WithOne("CompanyAccount")
                        .HasForeignKey("Payroll.Models.CompanyAccount", "UserId");

                    b.Navigation("AppUserOwner");
